...
public final class VoidedProtocol {
    ...
    public static final String ACTION_SERVICES_REQUEST = "services.request";
    public static final String ACTION_SERVICES_UNLOCK_EC = "services.unlock.enderchest";
    public static final String ACTION_SERVICES_UNLOCK_PV = "services.unlock.personalvault";
    ...
    public static final String CAP_SERVICES_COMPANION = "services-companion-v1";
