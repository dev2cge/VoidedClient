# VoidedClient 1.1.0 — Minecraft 26.2 build
...
```
Output: `fabric/build/libs/VoidedClient-Fabric-26.2-1.1.0.jar`

## Build Forge
```bat
gradlew :forge:clean :forge:build
```
Output: `forge/build/libs/VoidedClient-Forge-26.2-1.1.0.jar`
